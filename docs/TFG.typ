...
// #figure(
image("assets/diagrams/risk_schedule_modification.png"),
caption: "Risk: Modification of weekly working schedule",
)TODO poner imagen bien
#table(
...
// #figure(
image("assets/diagrams/risk_ory_learning_curve.png"),
caption: "Risk: Lack of experience with the Ory ecosystem and ReBAC implementation",
)
TODO poner imagen bien
#table(
  columns: (1fr, 1fr, 1fr, 1fr),
...
// #figure(
image("assets/diagrams/risk_ory_workflow_incompatibility.png"),
caption: "Risk: Incompatibility of expected workflow with Ory ecosystem",
)TODO poner imagen bien
...
// #figure(
image("assets/diagrams/opportunity.png"),
caption: "Opportunity: Acceleration and robustness gained through Ory ecosystem integration",
)TODO poner imagen bien
