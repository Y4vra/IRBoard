...
IR-Board is a Requirements Management Platform (RMP) designed to support the activities involved in the software requirements management process. The project addresses the need for a unified environment that facilitates the management of requirements sources and stakeholders, requirements elicitation and refinement, quality attribute verification, and compliance with established requirements engineering guidelines and standards, including IEEE 830 and ISO/IEC/IEEE 29148.

The platform provides support for documenting and managing different types of requirements engineering artifacts, including static and dynamic techniques such as use cases, flowcharts, and decision tables. Additionally, it supports the application of Agile methodologies through the documentation of artifacts such as user stories, allowing teams to incorporate Agile practices alongside traditional requirements engineering approaches.

To provide secure and flexible access management, IR-Board implements a Relation-Based Access Control (ReBAC) model within a Zero-Trust architecture, enabling permissions to be dynamically determined according to users' relationships with projects and system resources. The platform also includes collaborative capabilities, stakeholder management features, and mechanisms to improve traceability and coordination among project participants.

Furthermore, IR-Board incorporates workflow support, operational monitoring, and audit logging capabilities to improve project governance, system reliability, and administrative control. By combining structured requirements engineering practices with flexible documentation and collaboration features, IR-Board provides a comprehensive environment for modern software requirements management.
= Resumen
IR-Board es una Plataforma de Gestión de Requisitos (RMP, por sus siglas en inglés) diseñada para dar soporte a las actividades involucradas en el proceso de gestión de requisitos de software. El proyecto aborda la necesidad de disponer de un entorno unificado que facilite la gestión de fuentes e interesados, la obtención y refinamiento de requisitos, la comprobación de atributos de calidad y el cumplimiento de guías y estándares establecidos de ingeniería de requisitos, incluyendo IEEE 830 e ISO/IEC/IEEE 29148.

La plataforma proporciona soporte para documentar y gestionar diferentes tipos de artefactos de ingeniería de requisitos, incluyendo técnicas estáticas y dinámicas como casos de uso, diagramas de flujo y tablas de decisión. Además, permite la aplicación de metodologías ágiles mediante la documentación de artefactos como historias de usuario, facilitando la incorporación de prácticas ágiles junto con enfoques tradicionales de ingeniería de requisitos.

Para proporcionar una gestión de acceso segura y flexible, IR-Board implementa un modelo de Control de Acceso Basado en Relaciones (ReBAC, por sus siglas en inglés) dentro de una arquitectura de Confianza Cero (Zero Trust), permitiendo determinar los permisos dinámicamente según las relaciones de los usuarios con los proyectos y recursos del sistema. La plataforma también incorpora capacidades colaborativas, funcionalidades para la gestión de interesados y mecanismos destinados a mejorar la trazabilidad y coordinación entre los participantes del proyecto.

Además, IR-Board incorpora soporte para flujos de trabajo, monitorización operativa y registros de auditoría con el objetivo de mejorar la gobernanza del proyecto, la fiabilidad del sistema y su administración. Mediante la combinación de prácticas estructuradas de ingeniería de requisitos con capacidades flexibles de documentación y colaboración, IR-Board proporciona un entorno integral para la gestión moderna de requisitos de software.
= Keywords
Requirements Management Platform, Software Requirements Engineering, IEEE 830, ISO/IEC/IEEE 29148, Agile Methodology, Requirements Documentation, User Stories, Use Cases, Flowcharts, Decision Tables, Relation-Based Access Control (ReBAC), Zero-Trust Architecture, Requirements Elicitation, Requirements Refinement, Traceability, Stakeholder Management, Collaborative Engineering, Audit Logging, Project Governance.
= Palabras clave
Plataforma de Gestión de Requisitos, Ingeniería de Requisitos de Software, IEEE 830, ISO/IEC/IEEE 29148, Metodología Ágil, Documentación de Requisitos, Historias de Usuario, Casos de Uso, Diagramas de Flujo, Tablas de Decisión, Control de Acceso Basado en Relaciones (ReBAC), Arquitectura de Confianza Cero, Obtención de Requisitos, Refinamiento de Requisitos, Trazabilidad, Gestión de Interesados, Ingeniería Colaborativa, Registro de Auditoría, Gobernanza de Proyectos.
#pagebreak()
= About the document
...
#figure(image("/docs/assets/diagrams/frontendPackageDiagram.svg"),caption:"Frontend package diagram")
...
#page(flipped: true)[
  == Usability and Accessibility testing
  === Accessibility testing
  The recorded results where:
  #figure(table(
    columns:(1fr,1fr,1.25fr,3fr),
    table.header(
  ...
  === Usability and accessibility testing conclusions
  Several issues arise from the usability testing, from which we can obtain the following actions to mitigate their impact:
  #figure(table(
    columns:(1fr,2fr),
